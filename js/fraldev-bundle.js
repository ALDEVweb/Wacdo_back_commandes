...
// retour : rien
	...
	// enleve ou ajoute la class blur5
	burgerBlurs.forEach(burgerBlur=>{
		burgerBlur.classList.toggle("blur5")
	})
...
let oeilOuvertBlanc = `<img src="assets/picto/oeil_ouvert_blanc.svg" alt="oeil"></img>`;
let oeilFermeBlanc = `<img src="assets/picto/oeil_ferme_blanc.svg" alt="oeil"></img>`;
let oeilOuvertNoir = `<img src="assets/picto/oeil_ouvert_noir.svg" alt="oeil"></img>`;
let oeilFermeNoir = `<img src="assets/picto/oeil_ferme_noir.svg" alt="oeil"></img>`;  
